...
import { setWeatherData, selectWeatherDataChart } from '../reducers/chartReducer';
...
const Chart = () => {
  ...
  const weatherData = useSelector(selectWeatherDataChart);
  ...
  // Filtra i dati per ottenere solo le informazioni alla stessa ora ogni giorno
  const filteredData = weatherData.list.filter((item) => item.dt_txt.split(' ')[1] === targetHour);
